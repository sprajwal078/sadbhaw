...
<div class="header header-default <?php if($inwave_cfg['header-sticky'] == 1) { echo 'header-sticky' ;} if(!$inwave_cfg['slide-id']){if($inwave_cfg['show-pageheading'] == '0'){ echo ' no-pageheading'; echo  ' no-slider';}} ?> ">
    <!-- the header -->
