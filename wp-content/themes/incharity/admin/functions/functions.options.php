...
if (!function_exists('inwave_of_options')) {
    function inwave_of_options()
    {
        ...
        //Testing
        $inwave_of_options_select = array("one", "two", "three", "four", "five");
        $inwave_of_options_radio = array("one" => "One", "two" => "Two", "three" => "Three", "four" => "Four", "five" => "Five");

        //Sample Homepage blocks for the layout manager (sorter)
        $inwave_of_options_homepage_blocks = array
        (
            "disabled" => array(
        ...
        //Stylesheets Reader
        $alt_stylesheet_path = INWAVE_LAYOUT_PATH;
        ...
        $inwave_of_options_thumb_align = array("alignleft" => "Left", "alignright" => "Right", "aligncenter" => "Center");

        // Image Links to Options
        $inwave_of_options_image_link_to = array("image" => "The Image", "post" => "The Post");
...
// GENERAL SETTING
        $inwave_of_options[] = array("name" => "General setting",
            "type" => "heading"
        );
		$inwave_of_options[] = array("name" => "Show demo setting panel",
            "desc" => "Check this box to active the setting panel. This panel should be shown only in demo mode",
            "id" => "show_setting_panel",
            "std" => 0,
            "type" => "checkbox");
		$inwave_of_options[] = array("name" => "Show page heading",
            "desc" => "Check this box to show or hide page heading",
            "id" => "show_page_heading",
            "std" => 1,
            "type" => "checkbox");	
        $inwave_of_options[] = array("name" => "Retina support:",
        ...
        $inwave_of_options[] = array("name" => "Typography",
            "desc" => "",
            "id" => "typography",
            ...
            "position" => "start",
            "type" => "accordion");
        $inwave_of_options[] = array( "name" => esc_html__("Select Body Font Family", "inwavethemes"),
            "desc" => esc_html__("Select a font family for body text", "inwavethemes"),
            "id" => "gf_body",
            "std" => "Roboto Slab",
            "type" => "select",
            "options" => $google_fonts);
        $inwave_of_options[] = array( "name" => esc_html__("Select Menu Font", "inwavethemes"),
            "desc" => esc_html__("Select a font family for navigation", "inwavethemes"),
            "id" => "gf_nav",
            "std" => "",
            "type" => "select",
            "options" => $google_fonts);
        $inwave_of_options[] = array( "name" => esc_html__("Select Headings Font", "inwavethemes"),
            "desc" => esc_html__("Select a font family for headings", "inwavethemes"),
            "id" => "f_headings",
            "std" => "",
            "type" => "select",
            "options" => $google_fonts);
        $inwave_of_options[] = array( "name" => esc_html__("Google Font Settings", "inwavethemes"),
            "desc" => esc_html__("Adjust the settings below to load different character sets and types for fonts. More character sets and types equals to slower page load.", "inwavethemes"),
            "id" => "gf_settings",
            "std" => "100,300,400,700",
            "type" => "text");
        $inwave_of_options[] = array( "name" => esc_html__("Default Font Size", "inwavethemes"),
            "desc" => esc_html__("In pixels, default is 12", "inwavethemes"),
            "id" => "f_size",
            "std" => "12",
            "type" => "select",
            "options" => $font_sizes);
        $inwave_of_options[] = array( "name" => esc_html__("Default Font Line Height", "inwavethemes"),
            "desc" => esc_html__("In pixels, default is 24", "inwavethemes"),
            "id" => "f_lineheight",
            "std" => "24",
            "type" => "select",
            "options" => $font_sizes);
        ...
        $inwave_of_options[] = array("name" => "Layout",
            "type" => "heading"
        );

//		$inwave_of_options[] = array("name" => "Show breadcrumbs",
//            "desc" => "Check to display the breadcrumbs in general. Uncheck to hide them.",
//            "id" => "breadcrumb",
//            "std" => 1,
//            "type" => "checkbox");

		$inwave_of_options[] = array("name" => "Sidebar Position",
        ...
        $inwave_of_options[] = array("name" => "Boxed Mode Only",
            "desc" => "",
            "id" => "boxed_mode_only",
        ...
        $inwave_of_options[] = array("name" => "Background Image For Outer Areas In Boxed Mode",
        ...
        $inwave_of_options[] = array("name" => "Full Background Image",
        ...
        $inwave_of_options[] = array("name" => "Background Repeat",
        ...
        $inwave_of_options[] = array("name" => "Background Color",
        ...
        // COLOR PRESETS
        $inwave_of_options[] = array("name" => "Color presets",
            "type" => "heading"
        );

        $inwave_of_options[] = array("name" => "Primary Color",
        ...
        $inwave_of_options[] = array("name" => "Color Scheme",
            ...
            "position" => "start",
            "type" => "accordion");
        $inwave_of_options[] = array("name" => "Header Background Color",
            "desc" => "Select a color for the header background.",
            "id" => "header_bg_color",
            "std" => "",
            "type" => "color");
        $inwave_of_options[] = array("name" => "Header Top Background Color",
            "desc" => "Controls the background color of the top header section used in Header style 2.",
            "id" => "header_top_bg_color",
            "std" => "",
            "type" => "color");
        $inwave_of_options[] = array("name" => "Header Border Color",
            "desc" => "Select a color for the header border.",
            "id" => "header_bd_color",
            "std" => "",
            "type" => "color");

        $inwave_of_options[] = array("name" => "Content Background Color",
            "desc" => "Controls the background color of the main content area.",
            "id" => "content_bg_color",
            "std" => "",
            "type" => "color");

        $inwave_of_options[] = array("name" => "Footer Background Color",
            "desc" => "Select a color for the footer background.",
            "id" => "footer_bg_color",
            "std" => "",
            "type" => "color");
        $inwave_of_options[] = array("name" => "Footer Border Color",
            "desc" => "Select a color for the footer border.",
            "id" => "footer_border_color",
            "std" => "",
            "type" => "color");
        $inwave_of_options[] = array("name" => "Footer Back-to-top Background",
...
//            "type" => "color");
        ...
        //HEADER OPTIONS
        $inwave_of_options[] = array("name" => "Header Options",
            "type" => "heading"
        );
        $inwave_of_options[] = array("name" => "Header Info",
            "desc" => "",
        ...
        $inwave_of_options[] = array("name" => "Select a Header Layout",
            "desc" => "",
            "id" => "header_layout",
            "std" => "",
            "type" => "images",
            "options" => array(
                ...
                "v5" => get_template_directory_uri() . "/headers/previews/v5.jpg"
            ));
		$inwave_of_options[] = array("name" => "Sticky Header",
            "desc" => "Check to enable a fixed header when scrolling, uncheck to disable.",
            "id" => "header_sticky",
            "std" => '0',
            "type" => "checkbox");
        $inwave_of_options[] = array("name" => "Logo Sticky and Screen Mobile, Table",
            "desc" => "You can change logo header sticky when scroll mouse.",
            "id" => "logo_sticky",
            "std" => "",
            "type" => "upload");

        $inwave_of_options[] = array("name" => "Show quick access",
            "desc" => "Check to show quick access icons (for header style 5)",
            "id" => "show_quick_access",
            "std" => '1',
            "type" => "checkbox");

        $inwave_of_options[] = array("name" => "Show form search",
            "desc" => "Check to show form search (for header style 5)",
            "id" => "show_search_form",
            "std" => '1',
            "type" => "checkbox");

        $inwave_of_options[] = array("name" => "Background Image For Header Area",
        ...
        $inwave_of_options[] = array("name" => "100% Background Image",
        ...
        $inwave_of_options[] = array("name" => "Contact email",
            "desc" => "Contact email show in the header",
            "id" => "contact_email",
            "std" => "support@inwavethemes.com",
            "type" => "text");
        $inwave_of_options[] = array("name" => "Contact Mobile",
            "desc" => "Contact mobile show in header.",
            "id" => "contact_mobile",
            "std" => "+084 123456789",
            "type" => "text");
        $inwave_of_options[] = array("name" => "Show social links",
            "desc" => "Show social share links in header area (header v2 styles)",
            "id" => "header_social_links",
            "std" => '1',
            "type" => "checkbox");
        $inwave_of_options[] = array("name" => "Extra content",
...
<div class='contact-mobile''>+084 123456789</div>
            ...
            "type" => "textarea");
$inwave_of_options[] = array("name" => "Show Donate button",
		...
		$inwave_of_options[] = array("name" => "Donate button link",
            "desc" => "Donate button link to show in header",
            "id" => "donate_button_link",
            "std" => "#",
            "type" => "text");
		$inwave_of_options[] = array("name" => "Donate button text",
            "desc" => "Donate button text to show in header",
        ...
        $inwave_of_options[] = array("name" => "Logo",
        ...
        $inwave_of_options[] = array("name" => "Header Info",
            ...
            "position" => "start",
            "type" => "accordion");
        $inwave_of_options[] = array("name" => "Page Title Bar Height",
            "desc" => "In pixels, ex: 10px",
            "id" => "page_title_height",
            "std" => "280px",
            "type" => "text");

        $inwave_of_options[] = array("name" => "Page Title Bar Background",
        ...
        // FOOTER OPTIONS
        $inwave_of_options[] = array("name" => "Footer options",
            "type" => "heading"
        );
		$inwave_of_options[] = array("name" => "Footer style",
            "desc" => "",
            "id" => "footer_option",
            "std" => "v2",
            "type" => "images",
            "options" => array(
                "default" => get_template_directory_uri() . "/footer/previews/v1.jpg",
                "v2" => get_template_directory_uri() . "/footer/previews/v2.jpg"
            ));
        $inwave_of_options[] = array("name" => "Footer Logo Style 1",
        "desc" => "Please choose an image file for your footer logo.",
        "id" => "footer-logo",
        "mod" => "",
        "type" => "media");
        $inwave_of_options[] = array("name" => "Footer Logo Style 2",
            "desc" => "Please choose an image file for your footer logo style 2.",
            "id" => "footer-logo-2",
            "mod" => "",
            "type" => "media");
        $inwave_of_options[] = array("name" => "Footer description",
        ...
        $inwave_of_options[] = array("name" => "Footer buttons",
            "desc" => "",
            "id" => "footer_extra_links",
            "std" => "<a href=\"#\">About us</a>",
            "mod" => "",
            "type" => "textarea");

        $inwave_of_options[] = array("name" => "Footer copyright",
            "desc" => "Please enter text copyright for footer.",
            "id" => "footer-copyright",
            "std" => "Copyright 2016 &copy; <a href='#' class='theme-color'>InCharity</a>.  All rights reserved. Made with<i class='fa fa-heart theme-color'></i>by <a href='#' class='theme-color'>Inwavethemes</a>",
            "mod" => "",
            "type" => "textarea");

        $inwave_of_options[] = array("name" => "Footer Widgets",
            "desc" => "Check the box to display footer widgets.",
            "id" => "footer_widgets",
            "std" => 1,
            "type" => "checkbox");

        $inwave_of_options[] = array("name" => "Background Image For Footer Area",
        ...
        $inwave_of_options[] = array("name" => "Back to top button",
...
// SHOP OPTIONS
        $inwave_of_options[] = array("name" => "Shop options",
            "type" => "heading");

        $inwave_of_options[] = array("name" => "Show Woocommerce Cart Icon in Top Navigation",
            "desc" => "Check the box to show the Cart icon & Cart widget, uncheck to disable.",
            "id" => "woocommerce_cart_top_nav",
            "std" => 1,
            "type" => "checkbox");
        $inwave_of_options[] = array("name" => "Show Quick View Button",
            "desc" => "Check the box to show the quick view button on product image.",
            "id" => "woocommerce_quickview",
            "std" => 1,
            "type" => "checkbox");
        $inwave_of_options[] = array("name" => "Quick View Effect",
        ...
        $inwave_of_options[] = array("name" => "Product Listing Layout",
		 ...
		 $inwave_of_options[] = array("name" => "Troubleshooting",
        ...
        $inwave_of_options[] = array("name" => "Featured Image on Single Post Page",
            "desc" => "Check the box to display featured images on single post pages.",
            "id" => "featured_images_single",
            "std" => 1,
            "type" => "checkbox");

        $inwave_of_options[] = array("name" => "Post Title",
        ...
        $inwave_of_options[] = array("name" => "Show Author Info",
            "desc" => "Check the box to display the author info in the post.",
            "id" => "author_info",
            "std" => 1,
            "type" => "checkbox");

        $inwave_of_options[] = array("name" => "Related Posts",
        ...
        $inwave_of_options[] = array("name" => "Social Media",
            "type" => "heading"
        );
        $inwave_of_options[] = array("name" => "Social Sharing",
            "desc" => "",
            "id" => "social_sharing",
        ...
        $inwave_of_options[] = array(
            "position" => "end",
            "type" => "accordion");
        $inwave_of_options[] = array("name" => "Social Link",
            "desc" => "",
            "id" => "social_link",
        ...
        $inwave_of_options[] = array("name" => "Youtube",
            "desc" => "Enter your Youtube channel link.",
            "id" => "youtube_link",
            "std" => "#",
            "type" => "text");

        $inwave_of_options[] = array("name" => "Flickr",
            "desc" => "Enter your Flickr link.",
            "id" => "flickr_link",
            "std" => "#",
            "type" => "text");

        $inwave_of_options[] = array("name" => "Google+",
        ...
        $inwave_of_options[] = array("name" => "RSS",
            "desc" => "Enter your RSS link.",
            "id" => "rss_link",
            "std" => "",
            "type" => "text");

        $inwave_of_options[] = array("name" => "Instagram",
            "desc" => "Enter your instagram link.",
            "id" => "instagram_link",
            "std" => "",
            "type" => "text");

        $inwave_of_options[] = array("name" => "Vimeo",
        ...
        $inwave_of_options[] = array("name" => "Dribbble",
            "desc" => "Enter your Dribbble link.",
            "id" => "dribbble_link",
            "std" => "",
            "type" => "text");

        $inwave_of_options[] = array("name" => "Weibo",
            "desc" => "Enter your Weibo link.",
            "id" => "weibo_link",
            "std" => "",
            "type" => "text");

        $inwave_of_options[] = array("name" => "Dropbox",
            "desc" => "Enter your Dropbox link.",
            "id" => "dropbox_link",
            "std" => "",
            "type" => "text");

        $inwave_of_options[] = array("name" => "Skype",
            "desc" => "Enter your Skype account.",
            "id" => "skype_link",
            "std" => "",
            "type" => "text");

        $inwave_of_options[] = array("name" => "Playstore",
            "desc" => "Enter your Playstore link.",
            "id" => "android_link",
            "std" => "",
            "type" => "text");

        $inwave_of_options[] = array("name" => "Appstore",
        ...
        $inwave_of_options[] = array("name" => "Github",
...
// IMPORT EXPORT
        $inwave_of_options[] = array("name" => "Import Demo",
            "type" => "heading"
        );
        $inwave_of_options[] = array("name" => "Import Demo Content",
            ...
            "type" => "import_button");
// BACKUP OPTIONS
        $inwave_of_options[] = array("name" => "Backup Options",
            "type" => "heading"
        );
        $inwave_of_options[] = array("name" => "Backup and Restore Options",
            "id" => "of_backup",
            "std" => "",
            "type" => "backup",
        ...
        $inwave_of_options[] = array("name" => "Transfer Theme Options Data",
            "id" => "of_transfer",
            "std" => "",
            "type" => "transfer",
