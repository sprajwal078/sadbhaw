...
<form method="post">
	...
	<div class="login-form-button">
		...
		<button type="submit" class="button" name="login" value="<?php esc_attr_e( 'Login', 'woocommerce' ); ?>"><!--<em class="fa-icon"><i class="fa fa-unlock"></i></em>--><?php esc_html_e( 'Login', 'woocommerce' ); ?></button>
