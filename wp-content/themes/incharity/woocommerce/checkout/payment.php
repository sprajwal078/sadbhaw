...
<div id="payment" class="woocommerce-checkout-payment payment-method">
	...
	<div class="form-row place-order">
        <noscript>
            <?php echo wp_kses_post(__( 'Since your browser does not support JavaScript, or it is disabled, please ensure you click the <em>Update Totals</em> button before placing your order. You may be charged more than the amount stated above if you fail to do so.', 'woocommerce' )); ?>
