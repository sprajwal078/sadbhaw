			...
			<div class="row">
					...
					<div class="checkout-row col-md-6">
						...
						<div class="checkout-box checkout-box-order">	
							<div id="order_review_heading" class="title"><?php esc_html_e( 'Your order', 'woocommerce' ); ?></div>
							<div class="box">
...
<!--	<div id="order_review" class="woocommerce-checkout-review-order">
		<div class="row">
			<div class="checkout-row col-md-6">
				<div id="order_review_heading" class="title"><?php esc_html_e( 'Your order', 'woocommerce' ); ?><i class="fa fa-minus-square-o"></i></div>
				<div class="box">
			<?php do_action( 'woocommerce_checkout_order_review' ); ?>
				</div>
			</div>
