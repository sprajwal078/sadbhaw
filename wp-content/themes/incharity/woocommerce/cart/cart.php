			...
			<div class="cart-table-items">
                <div class="cart-table-title">
					<div class="row row-item">
						...
						<div class="col-md-5 col-sm-5 col-xs-12 item no-border"><div class="title-cart-table"><?php esc_html_e('Product', 'woocommerce'); ?></div></div>
						<div class="col-md-2 col-sm-2 col-xs-12 item"><div class="title-cart-table"><?php esc_html_e('Price', 'woocommerce'); ?></div></div>
						<div class="col-md-2 col-sm-2 col-xs-12 item"><div class="title-cart-table"><?php esc_html_e('Quantity', 'woocommerce'); ?></div></div>
						<div class="col-md-2 col-sm-2 col-xs-12 item"><div class="title-cart-table"><?php esc_html_e('Total', 'woocommerce'); ?></div></div>
				...
				<div class="woo-cart-coupon">
                    ...
                    <div class="row-item woo-coupon-row">
                        ...
                        <input type="text" name="coupon_code" class="input-text" id="coupon_code" value=""
                            ...
                            <button type="submit" class="button update_cart" name="update_cart" value="<?php esc_attr_e('Update Cart', 'woocommerce'); ?>">
