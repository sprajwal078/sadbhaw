...
<div class="product_meta">
	...
	<?php if ( wc_product_sku_enabled() && ( $product->get_sku() || $product->is_type( 'variable' ) ) ) : ?>
		...
		<div class="sku_wrapper"><label><?php esc_html_e( 'SKU:', 'woocommerce' ); ?></label><span class="sku" itemprop="sku"><?php echo ( $sku = $product->get_sku() ) ? $sku : esc_html__( 'N/A', 'woocommerce' ); ?></span>.</div>
    ...
    <div class="social-icon product_detail_share_icon">
            <label><?php echo esc_html__('Share This Post', 'incharity'); ?></label>
            <?php
