                                        ...
                                        mapPlaces: [
                                            {
                                                ...
                                                "latitude": <?php echo $campaignInfo->map_pos['latitude'] ? $campaignInfo->map_pos['latitude'] : 'null'; ?>,
                                                "longitude": <?php echo $campaignInfo->map_pos['longitude'] ? $campaignInfo->map_pos['longitude'] : 'null'; ?>,
                                                "description": ""
                                            }
                                        ],
                                        mapProperties: {
                            ...
                            <div class="donors-user">
                                <div class="donors-members">
                                    ...
                                    foreach ($campaignInfo->orders as $ord) {
                                        $member_field = $ord->getMember()->getField_value();
                                        ?>
                                        <div class="donors-member">
                                            <div class="mem-avata"><?php echo get_avatar($member_field[2]['value'], '70'); ?></div>
                                            <div class="mem-info">
                                                <div class="donate-info">
                                                    <div class="mem-name">
                                                        <?php echo ($ord->getMember()->getId() ? (($member_field[0]['name'] == 'full_name' && $member_field[0]['value']) ? $member_field[0]['value'] : __('No Name', 'inwavethemes')) : __('Anonymous', 'inwavethemes')); ?>
                                                    </div>
                                                    <div class="date">
