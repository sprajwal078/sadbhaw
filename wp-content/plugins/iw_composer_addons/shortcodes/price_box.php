                    ...
                    <div class="pricebox <?php echo $class ?>">
                        ...
                        <div class="pricebox-body">
                            <div class="pricebox-body-content">
                                ...
                                if ($purchase_text) {
                                    ?>
                                    <div class="pricebox-purchased-link"><a class="ibutton ibutton1 ibutton-small ibutton-effect1"
                            ...
                            <div class="pricebox-body-content">
                                ...
                                if ($purchase_text) {
                                    ...
                                    <div class="pricebox-purchased-link">
                                        <a href="<?php echo $purchase_link ?>" class="ibutton ibutton1 ibutton-small ibutton-effect1"><span class="ibutton-inner"><?php echo $purchase_text ?></span></a>
                                    </div>
                                    <?php
                                }
                                ?>
                    ...
                    <div class="pricebox <?php echo $class ?>">
                        ...
                        <div class="pricebox-col3 theme-bg">
                            ...
                            <?php if ($purchase_text) { ?>
                                <div class="pricebox-purchased-link">
                                    <a href="<?php echo $purchase_link ?>" class="ibutton ibutton2 ibutton-effect2"><span class="ibutton-inner"><?php echo $purchase_text ?></span></a>
                                </div>
                            <?php } ?>
                        </div>
                ...
                <?php case 'style6': ?>
                    <div class="pricebox style6">
                        <div class="pricebox-body">
                            ...
                            <?php if ($purchase_text) { ?>
                                <div class="pricebox-purchased-link">
                                    <a href="<?php echo $purchase_link ?>" class=""><span class="ibutton-inner"><?php echo $purchase_text ?></span></a>
                                </div>
                            <?php } ?>
                            <div style="clear:both;"></div>
                        </div>
                            ...
                            <div class="pricebox-body-content">
                                ...
                                <div
                                    ...
                                    if ($purchase_text) {
                                        ?>
                                    <div class="pricebox-purchased-link">
                                        <a href="<?php echo $purchase_link ?>" class="ibutton ibutton3 ibutton-small ibutton-effect1"><span class="ibutton-inner"><?php echo $purchase_text ?></span></a>
