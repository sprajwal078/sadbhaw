...
if (!class_exists('Inwave_Info_List')) {
    ...
    class Inwave_Info_List {
                ...
                "params" => array(
                    ...
                    array(
                        ...
                        "value" => array(
                            ...
                            "Style 5" => "style5",
                            "Style 6" => "style6",
                            "Style 7 - Underline icon" => "style7",
                            "Style 8 - Line through icon" => "style8",
							"Style 9 - Line through 2 icon" => "style9",
                        )
                    ),
                    array(
                        "type" => "textfield",
        ...
        function inwave_info_item_shortcode($atts, $content = null) {
            ...
            $output = $style = $icon = $icon_size = $title = $align = $css = $class = $img_tag = '';
            ...
            switch ($style) {
                case 'style1':
                    ...
                    if ($icon) {
                        if($link) {
                            ...
                            $output .= '<div class="icon"><i style="font-size:'.$icon_size.'px" class="theme-bg ' . $icon . '"></i></div>';
                        }
                    }
                    ...
                    $output .= '<div class="iw-bottom-icon">
                ...
                case 'style2':
                    ...
                    if ($icon) {
                        if($link){
                            $output .= '<div class="icon ' . $class . '"><a href="' . $link . '"><i class="theme-color ' .  $icon . '"></i></a></div>';
                        }else{
                            $output .= '<div class="icon ' . $class . '"><i class="theme-color ' .  $icon . '"></i></div>';
                        }
                    }
                    $output .= '<div class="info-item-content">';
                    if ($title) {
                ...
                case 'style7':
                    $output .= '<div class="info-item ' . $class . ' theme-bg-hover">';
                    if ($icon) {
                        if($link) {
                            $output .= '<div class="icon"><a href="' . $link . '"><i style="font-size:' . $icon_size . 'px" class="' . $icon . '"></i></a></div>';
                        }else{
