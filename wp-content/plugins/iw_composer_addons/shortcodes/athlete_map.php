...
if (!class_exists('Athlete_Map')) {
    ...
    class Athlete_Map {
        ...
        function athlete_map_shortcode($atts, $content=null) {
            ...
            $html .= '<div class="map-contain" data-title="' . $marker_title . '" data-image="' . $img . '" data-lat="' . $latitude . '" data-long="' . $longitude . '" data-zoom="' . $zoom . '" data-info="' . htmlentities($content) . '"><div class="map-view map-frame" '.$height.'></div></div>';
            $html .='</div>';
