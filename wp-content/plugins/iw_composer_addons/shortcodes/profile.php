...
if (!class_exists('Inwave_Profile_Slider')) {
    ...
    class Inwave_Profile_Slider {
        ...
        function inwave_profile_slider_shortcode($atts, $content = null) {
            ...
            $output .= '<div id="iw-item-slider profile_slider" class="dg-container fit-video">';
            ...
            $output .= '</div>';
            $output .= '</div>';
            $output .= '<div class="item-info-view profile-info-view"></div>';
            $output .= '</div>';
        ...
        function inwave_profile_item_shortcode($atts, $content = null) {
            ...
            switch ($style) {
                case 'style1':
                    $output .= '<div class="row"><div class="profile-box ' . $class . '">';
                ...
                case 'style4':
                    ...
                    $output .= '<div class="item-info-wrap profile-info-wrap">';
                    $output .= '<div class="profile-info"><h3 class="name">' . $name . '</h3><div class="position">' . $position . '</div><div class="description">' . $description . '</div></div>';
                    $output .= '<div class="social-links">';
                    foreach ($social_links as $link) {
                        $domain = explode(".com", $link);
                ...
                break;
				case 'style5':
                    $output .= '<div class="profile-box theme-bg item item' . $this->count++ . ' ' . $class . '">';
					
                    $output .= '<div class="profile-image">' . $img_tag . '</div>';
                    $output .= '<div class="profile-info theme-bg"><h3 class="name">' . $name . '</h3><div class="description">' . $description . '</div>';
                    $output .= '<div class="social-links">';
                    foreach ($social_links as $link) {
                        $domain = explode(".com", $link);
