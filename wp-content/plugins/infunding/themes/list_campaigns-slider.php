    ...
    while ($query->have_posts()) :
        ...
        <div class="iw-campaign-slider-item">
            <div class="item-info-warp">
                <div class="iw-row">
                    <div class="iw-campaign-image iw-col-md-7 iw-col-sm-12 iw-col-xs-12">
                        <?php
...
//                            var_dump($img); die();
                    ...
                    <div class="campaign-info iw-col-md-5 iw-col-sm-12 iw-col-xs-12">
                            ...
                            if ($show_progress):
                                ...
                                <div class="campaing-progress">
                                    ...
                                    if ($goal) {
                                        ...
                                        echo '<div class="camp-timeremaining-goal"><span class="camp-goal">' . ($utility->getMoneyFormated(number_format($current, 0, ',', '.'), get_post_meta(get_the_ID(), 'inf_currency', true)) . ' ' . __('to go', 'inwavethemes')) . '</span></div>';
                                    }
                                    ?>
                                </div>
                            <?php endif; ?>
